...
export default function Signup({ navigation }) {
  ...
  const handleSubmit = () =>{
    if (email !=="" && password!=="") {
        createUserWithEmailAndPassword(auth, email, password)
          .then(()=> Alert.alert("Se registro correctamente"))
          .catch((err) => {
  ...
  return (
    <View style={styles.maincontainer}>
      ...
      <Text style={styles.parrafo}>Registrate para poder adoptar una mascota</Text>
      <TextInput 
      ...
      <TouchableOpacity style={styles.botonprincipal} onPress={handleSubmit}>
        ...
        style={styles.boton}
        >
        <Text style={styles.nombreBoton}>Registrate</Text>
      </Gradient>
    </TouchableOpacity>

      <View style={styles.navegacion}>
      <Text style={styles.cuenta}>¿Ya tienes una cuenta?</Text>
